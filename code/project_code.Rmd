...
rocket_sampling(20, 3, 3, curr.index = 10, dist = null_dist)
```

```{r Sampling for other techniques}
n_iters = 3000
rocket_samples = rocket_sampling(20, 3, 3, dist = absolute_dist, n_iter = n_iters)
...
null_rocket_samples = rocket_sampling(20, 3, 3, curr.index = 5, dist = null_dist)
plot_traces_and_hist(null_rocket_samples)
sqr_rocket_samples = rocket_sampling(20, 3, 3, curr.index = 2, dist = sqr_dist)
plot_traces_and_hist(sqr_rocket_samples)
```
...
div = 0
for (i in 1:iters) {
  local.temp = rocket_sampling(20, 3, 3, curr.index = 10, dist = absolute_dist)
  time = mixing_time(x = local.temp, initial = 10)
